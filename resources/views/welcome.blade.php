...
<html lang="en-US">
	<head>
        ...
        <!-- <link rel="stylesheet" href="{{ asset('assets/css/skin/ice-blue.css') }}"> -->
        <!-- <link rel="stylesheet" href="{{ asset('assets/css/skin/summer-orange.css') }}"> -->
        <!-- <link rel="stylesheet" href="{{ asset('assets/css/skin/fresh-lime.css') }}"> -->
        <!-- <link rel="stylesheet" href="{{ asset('assets/css/skin/night-purple.css') }}"> -->
    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
			...
			<section id="text-carousel-intro-section" class="parallax" data-stellar-background-ratio="0.5" style="background-image: url({{ asset('assets/img/slider-bg.jpg') }});">
          ...
          <!-- End cta -->
                                        ...
                                        <div class="row"  id="portfolio">
                                            <div class="col-xs-12 col-sm-4 appsDevelopment">
                                                <div class="portfolio_single_content">
                                                    <img src="{{ asset('assets/img/portfolio/p1.jpg') }}" alt="title"/>
                                                    <div>
            ...
            <section id="counter-section">                					
				<div id="counter-up-trigger" class="counter-up text-white parallax" data-stellar-background-ratio="0.5" style="background-image: url({{ asset('assets/img/counter-bg.jpg') }});">
					<div class="cover"></div>
                    <!-- Begin page header-->
                    <div class="page-header-wrapper">
                        <div class="container">
		...
		<script src="{{ asset('assets/inc/smoothscroll.js') }}"></script>
